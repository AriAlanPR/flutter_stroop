...
class BouncingSquare extends StatefulWidget {
  ///Size of the container that envelopes the square
  final double containerSize;
  ///Size of the square
  final double squareSize;
  ///Offset of the shadow from the square. It represents a separation between the square and the shadow.
                        ...
                        child: BackdropFilter(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Colors.black
                                  .withValues(alpha: _shadowOpacityAnimation.value),
